...
public class ModBlocks {
    ...
    public static final RecaptchaTableBlock RECAPTCHA_TABLE_BLOCK = new RecaptchaTableBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f));
    ...
    public static BlockItem RECAPTCHA_TABLE_ITEM;
    public static RecaptchaTableBlock RECAPTCHA_TABLE_BLOCK_BLOCK;
    ...
    public static void register() {
        ...
        RECAPTCHA_TABLE_BLOCK_BLOCK = Registry.register(BLOCK, new ResourceLocation(MOD_ID, "recaptcha_table"), RECAPTCHA_TABLE_BLOCK);
        RECAPTCHA_TABLE_ITEM = Registry.register(ITEM, new ResourceLocation(MOD_ID, "recaptcha_table"), new BlockItem(RECAPTCHA_TABLE_BLOCK, new FabricItemSettings()));
        ModRegistries.register_item(RECAPTCHA_TABLE_ITEM);
    }
}
